...
namespace FileParserTests
{
    public class FileParserTests
    {
        ...
        private string _csvPath = Environment.GetEnvironmentVariable("HOME") + "D:/Coding/data.csv";  // change to appropriate path
        private string _tsvPath = Environment.GetEnvironmentVariable("HOME") + "D:/Coding/data.tsv";  // change to appropriate path

        private string _writeFile = Environment.GetEnvironmentVariable("HOME") + "D:/Coding/dataWrite.txt";  // change to appropriate path
